  ...
  const interviewAreas: InterviewArea[] = [
    {
      ...
      description: "Tests technical knowledge and problem-solving abilities. i.e Coding challenges, system design, troubleshooting scenarios.",
      icon: <HiOutlineCubeTransparent size={60} />
    },
    {
      id: "behavioral",
      title: "Behavioral Interviews",
      description: "Evaluates past behavior to predict future performance. i.e \"Tell me about a time when...\", \"How do you handle conflict?\"",
      icon: <PiUserCircleDashedLight size={60} />
    },
    {
      id: "situational",
      title: "Situational Interviews",
      description: "Assesses how candidates would handle hypothetical situations. i.e \"What would you do if...\", \"How would you approach...\"",
      icon: <LuMessageSquareDashed size={60} />
    },
    {
      id: "mock-interview",
      title: "Mock Interview",
      description: "Simulate a real interview experience, covering all aspects of a real interview. Perfect for comprehensive preparation.",
  ...
  const difficultyLevels: DifficultyLevel[] = [
    {
      id: "novice",
      title: "Novice",
      description: "Covers fundamental concepts and easy questions to help you get started.",
      image: "/assets/novice.png"
    },
    {
      id: "advanced",
      title: "Advanced",
      description: "Includes moderately challenging questions to build on your skills.",
      image: "/assets/advanced.png"
    },
    {
      id: "hard",
      title: "Hard",
      description: "Features complex and in-depth questions to test your expertise.",
      ...
      <div className="w-full space-y-8">
        <div className="flex items-center gap-8 justify-between">
            ...
            <div className="flex-1">
                ...
                <span className="text-primary font-semibold">area</span>,{" "}
                <span className="text-primary font-semibold">difficulty</span>,{" "}
                <span className="text-primary font-semibold">desired job title</span> and press the{" "}
                <span className="text-primary font-semibold">Start</span> button whenever you're ready.
                </h2>
            </div>
            <div className="ml-6">
                <Image
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
                Remember, ACE is tracking your response times. Make sure to 
                answer within the allotted time, or ACE will assume you're 
              ...
              {interviewAreas.map((area) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`rounded-xl p-1 mt-1 ${selectedArea === area.id ? "text-primary bg-white" : "text-white bg-primary"}`}>
                      {area.icon}
                    </div>
                    <div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center">
                <BsClock className="text-orange-500 dark:text-orange-400" size={24} />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Pro Tip
              </h3>

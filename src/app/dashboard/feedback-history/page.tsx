...
export default function FeedbackHistoryPage() {
  ...
  const [startDate, setStartDate] = useState<Date | null>(new Date(2024, 6, 27));
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case "Mock": return <IoCheckmarkCircle className="w-4 h-4" />;
        ...
        <div className="flex-1">
          ...
          <div className="space-y-6">
                  ...
                  <label key={rating} className="flex items-center cursor-pointer">
                    ...
                    i < rating ? (
                      ...
                      />
                         ...
                         <span className={`text-xs ${selectedRating === rating ? "font-semibold" : "font-normal text-gray-600"}`}>
                           {rating}
                         </span>
                       </div>
                       {selectedRating === rating && <FaCheck className="w-3 h-3 text-primary" />}
                     </div>
                  </label>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                {["Technical", "Behavioral", "Situational", "Mock"].map((category) => (

...
const conversations: Conversation[] = [
    {
        ...
        messages: [
            {
                id: 1,
                text: "Help me prepare for a software engineer interview at Google",
                sender: "user",
                delay: 1000,
            },
            {
                id: 2,
                text: "I'd love to help you prepare for your Google software engineer interview! Let's start with some common technical questions. Can you walk me through how you would approach designing a scalable chat application?",
                sender: "ai",
                delay: 2000,
            },
            {
                id: 3,
                text: "I'd start by identifying the key components: user authentication, message storage, real-time messaging, and notification system",
                sender: "user",
                delay: 3000,
            },
            {
                id: 4,
                text: "Excellent start! Your approach shows good system design thinking. For the real-time messaging, what technologies would you consider and why?",
                sender: "ai",
                delay: 2500,
            },
        ],
    },
    {
        ...
        messages: [
            {
                id: 1,
                text: "I'm nervous about behavioral questions. Can you help me practice?",
                sender: "user",
                delay: 1000,
            },
            {
                id: 2,
                text: "Absolutely! Behavioral questions are crucial for showing your soft skills. Let's practice with a common one: 'Tell me about a time you had to work with a difficult team member.'",
                sender: "ai",
                delay: 2000,
            },
            {
                id: 3,
                text: "At my last job, I had to collaborate with a colleague who was often dismissive of others' ideas during meetings",
                sender: "user",
                delay: 3000,
            },
            {
                id: 4,
                text: "Great setup! Now tell me about the specific actions you took to address this situation. Remember to use the STAR method - what was your specific Task, Action, and Result?",
                sender: "ai",
                delay: 2500,
            },
        ],
    },
    {
        ...
        messages: [
            {
                id: 1,
                text: "What questions should I ask at the end of my interview?",
                sender: "user",
                delay: 1000,
            },
            {
                id: 2,
                text: "Great question! Asking thoughtful questions shows genuine interest. Here are some powerful ones: 'What does success look like in this role after 6 months?' and 'What challenges is the team currently facing?'",
                sender: "ai",
                delay: 2000,
            },
            {
                id: 3,
                text: "Those are good! Should I ask about company culture too?",
                sender: "user",
                delay: 2500,
            },
            {
                id: 4,
                text: "Absolutely! Try: 'How would you describe the team dynamics and collaboration style?' This shows you value teamwork and want to ensure you're a good fit.",
                sender: "ai",
                delay: 2000,
            },
        ],
                    ...
                    <div className="flex items-start gap-3 max-w-4xl">
                        ...
                        <div className="bg-white dark:bg-gray-700 rounded-2xl rounded-tl-md px-4 py-3 shadow-sm border border-gray-100 dark:border-gray-600 max-w-[85%]">
                            <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
                                Hi! I'm your AI interview coach. I can help you
                                practice for any interview. What would you like
                                to work on today?
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                Live demo - See how Ace AI coaches you through
                                interviews
                            </div>
                        </div>

...
export default function LanguageSettings() {
  ...
  return (
    <div className={`w-full`}>
      <h2 className={`text-lg font-semibold ${titleColor} mb-6`}>Language</h2>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <span className={selectedLanguageName ? textColor : "text-gray-500"}>
        ...
        {isOpen && (
          <div className={`absolute z-10 w-full mt-1 border ${borderColor} rounded-md shadow-lg ${dropdownBgColor}`}>
            <div className="py-1">

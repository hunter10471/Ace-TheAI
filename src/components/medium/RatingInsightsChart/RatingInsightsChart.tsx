...
import { Line, XAxis, YAxis, ResponsiveContainer, ComposedChart, Bar, Tooltip } from "recharts"
...
export default function RatingInsightsChart() {
  ...
  return (
    <div className={`w-full max-w-[1000px]`}>
      <h2 className={`text-lg font-semibold ${titleColor} mb-6`}>Rating Insights</h2>

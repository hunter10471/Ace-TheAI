...
export default function InterviewHistoryTable() {
  ...
  return (
    <div className="w-[80%] max-w-[700px]">
      <h2 className={`text-lg font-semibold ${titleColor} mb-6`}>Interview History</h2>
          ...
          <TableHeader>
            <TableRow className="border-b">
              <TableHead
               ...
               <TableHead className={`font-medium ${headTextColor} h-8 px-2`}>Feedback</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {interviewData.map((interview, index) => (
              <TableRow key={index} className={`border-b last:border-b-0 h-10`}>
                <TableCell className={`font-medium ${cellTextColor} px-2 py-1`}>{interview.date}</TableCell>
                <TableCell className={`font-medium ${cellTextColor} px-2 py-1`}>{interview.jobTitle}</TableCell>
                <TableCell className="px-2 py-1">
                  <TagPill type="category" value={interview.category} />
                </TableCell>
                <TableCell className="px-2 py-1">
                  <TagPill type="difficulty" value={interview.difficulty} />
                </TableCell>
                <TableCell className={`font-medium ${cellTextColor} px-2 py-1`}>{interview.rating}</TableCell>
                <TableCell className={`${feedbackTextColor} max-w-xs px-2 py-1`}>{interview.feedback}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>

...
export default function FeedbackCard({ feedback, onExpand }: FeedbackCardProps) {
  ...
  return (
    <div className="flex flex-col justify-between bg-white rounded-2xl border border-black p-4 h-80">
      ...
      <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2">{feedback.title}</h3>

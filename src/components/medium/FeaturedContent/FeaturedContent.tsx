...
const FeaturedContentCard: React.FC<FeaturedContentCardProps> = ({
  ...
  return (
    <div className="bg-[#2D2D2D] rounded-2xl p-4 w-[180px] h-[160px] flex flex-col justify-between transition-all hover:shadow-lg cursor-pointer border border-gray-800 dark:border-gray-700">
      <div>
        <h3 className="text-white font-medium text-base mb-2 leading-tight">{title}</h3>
        <p className="text-gray-300 dark:text-gray-400 text-xs leading-relaxed">{description}</p>
      </div>
...
const FeaturedContent: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Featured Content</h2>

...
import { Bar, XAxis, YAxis, ResponsiveContainer, BarChart, Tooltip, Cell } from "recharts"
import { ChartContainer } from "@/components/ui/chart"
import { useState } from "react"
import { useThemeStore } from "@/lib/store"

const data = [
  { category: "Tech.", fullLabel: "Technical", percentage: 100, color: "#FFF1D4", stroke: "#F3CD7D" },
  { category: "Behav.", fullLabel: "Behavioral", percentage: 60, color: "#C1DCFB", stroke: "#92C3FA" },
  { category: "Situat.", fullLabel: "Situational", percentage: 25, color: "#FBCFAE", stroke: "#F3AF7D" },
]
...
export default function PerformanceCategoryChart() {
  ...
  return (
    <div className={`w-full max-w-[500px]`}>
      <h2 className={`text-lg font-semibold ${titleColor} mb-4`}>Performance by Category</h2>

...
const Calendar: React.FC<CalendarProps> = ({
  ...
  const renderCalendarDays = () => {
    ...
    while (day <= endDate) {
      for (let i = 0; i < 7; i++) {
        ...
        let dayClasses = "w-8 h-8 flex items-center justify-center rounded-md text-sm cursor-pointer transition-colors";
        ...
        if (!isCurrentMonth) {
          ...
          dayClasses += " bg-primary/20 dark:bg-primary/30 text-primary font-medium";
        } else {
          dayClasses += " text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100";
        }
  ...
  return (
    <div className="h-[300px] mt-8 w-[280px] bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">

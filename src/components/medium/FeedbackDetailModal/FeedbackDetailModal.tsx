...
import { FaCalendarAlt, FaChevronUp, FaChevronDown, FaTimes } from "react-icons/fa";
...
const mockQuestions: Question[] = [
  {
    ...
    feedback: "Good explanation. You could enhance your answer by mentioning the four main principles of OOP: encapsulation, inheritance, polymorphism, and abstraction."
  },
  {
    id: 2,
    ...
    feedback: "Solid understanding of REST principles. Consider mentioning statelessness and the importance of proper HTTP status codes in your response."
  },
  {
    id: 3,
    ...
    feedback: "Good comparison. You could elaborate on specific use cases for each type and mention popular examples like MySQL vs MongoDB."
  },
  {
    id: 4,
    ...
    feedback: "Excellent explanation. You might want to mention specific tools like Git and how branching strategies work in team environments."
  }
];
      ...
      modalBody={
        <div>
            ...
            <div className="text-center mb-2 mt-5">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">{feedback.title}</h2>
                <div className="flex items-center gap-2 justify-center mb-5">
                {renderStars(feedback.rating)}
                </div>
                <TagPill className="px-4 py-2 text-[15px]" type="category" value={feedback.category} />
            </div>
                ...
                <div key={question.id}>
                  ...
                  {expandedQuestions.includes(question.id) && (
                    <div className="px-4 pb-4 space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1 text-sm">Answer:</h4>
                        <p className="text-gray-700 text-sm leading-relaxed">{question.answer}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1 text-sm">Feedback:</h4>
                        <p className="text-gray-700 text-sm leading-relaxed">{question.feedback}</p>
                      </div>
                    </div>
                  )}
                </div>
